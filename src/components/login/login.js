								...
								<div className="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
									<form>
										...
										<div className="form-outline mb-4">
											...
											<input type="email" id="email" className="form-control form-control-lg fs-6 bg-light" placeholder="Introduzca una dirección de correo electrónico válida." />
										</div>

										<div className="form-outline mb-3">
											<label className="form-label fw-bolder d-flex justify-content-start" for="password">Contraseña</label>
											<input type="password" id="password" className="form-control form-control-lg fs-6 bg-light" placeholder="Introduzca la contraseña." />
										</div>
										...
										<div className="text-center text-lg-center mt-4 pt-2">
											<button type="button" className="btn-lg color-button"git><FontAwesomeIcon icon={faRightToBracket} /> Iniciar sesión</button>
											...
											<button type="button"  className="btn-lg color-button"><FontAwesomeIcon icon={faUserPlus} /> Registrarse</button>											
										</div>
									</form>
								</div>
							</div>
